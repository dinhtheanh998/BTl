...
namespace BTL_LTQL.Areas.Admins.Controllers
{
    public class DonHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DonHangID,Ngaydat,NgayGiao,UserName")] DonHang donHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DonHangID,Ngaydat,NgayGiao,UserName")] DonHang donHang)
        {
            if (ModelState.IsValid)
            {
